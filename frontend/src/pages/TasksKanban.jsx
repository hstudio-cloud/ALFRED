...
const TasksKanban = () => {
  ...
  const fetchTasks = async () => {
    ...
    try {
      const response = await axios.get(`${API}/tasks-enhanced?workspace_id=${currentWorkspace.id}`);
  ...
  const handleDelete = async (taskId) => {
    ...
    try {
      await axios.delete(`${API}/tasks-enhanced/${taskId}?workspace_id=${currentWorkspace.id}`);
      toast({
        title: 'Sucesso',
