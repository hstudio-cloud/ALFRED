      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-16 text-center space-y-4">
          ...
          <h2 className="text-4xl font-bold md:text-5xl">
            <span className="text-white">Sua operação organizada </span>
            <span className="bg-gradient-to-r from-red-300 to-amber-300 bg-clip-text text-transparent">
              em um só lugar
            </span>
          </h2>
          <p className="text-xl text-slate-400">
            Cada área com exemplos reais de uso financeiro.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="rounded-lg border border-slate-700/30 bg-slate-900/50 p-6">
                ...
                <div className="mt-1 text-xs text-red-300">+12% este mês</div>
              </div>
              <div className="rounded-lg border border-slate-700/30 bg-slate-900/50 p-6">
                <div className="mb-3 flex items-center justify-between">
            ...
            <div className="space-y-3">
              ...
              {[1, 2, 3].map((item) => (
                <div
                  key={item}
                  className="rounded-lg border border-slate-700/30 bg-slate-900/50 p-4 transition-all hover:border-red-500/30"
                >
                  <div className="flex items-center gap-4">
                    <div className="h-2 w-2 rounded-full bg-red-300" />
                    <div className="flex-1">
                      <div className="font-medium text-white">
                        Exemplo de item {item}
                      </div>
                      <div className="mt-1 text-xs text-slate-400">
                        Organizado automaticamente pelo Nano IA
                      </div>
                    </div>
