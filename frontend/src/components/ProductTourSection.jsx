    ...
    <section id="product-tour" className="px-6 py-20">
      <div className="mx-auto max-w-6xl">
        <div className="mb-16 text-center space-y-4">
          <p className="text-sm font-semibold uppercase tracking-wider text-red-300">Tour pelo produto</p>
          <h2 className="text-4xl font-bold md:text-5xl">
            <span className="text-white">Cada parte da sua operacao, </span>
            <span className="bg-gradient-to-r from-red-300 to-amber-300 bg-clip-text text-transparent">organizada em um so lugar</span>
          </h2>
          <p className="text-xl text-slate-400">Explore como o Nano IA transforma pagamentos, recebimentos e rotina financeira em acoes claras.</p>
        </div>
        ...
        {activeTab === 0 ? (
          <div className="grid gap-8 md:grid-cols-2">
            <div className="space-y-6">
              <h3 className="text-3xl font-bold text-white">Converse com sua IA financeira</h3>
              <p className="text-lg leading-relaxed text-slate-400">
                Interaja naturalmente por texto ou voz. O Nano IA entende contexto, classifica gastos e organiza cobrancas, contas e lembretes.
              </p>
              ...
              <Button className="rounded-full bg-red-500 px-6 py-6 text-white hover:bg-red-600">Experimentar</Button>
            </div>

            <Card className="border-slate-700/50 bg-slate-800/30 p-6">
              <div className="space-y-4">
                <div className="flex gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-red-500/20 text-sm text-red-200">U</div>
                  <div className="rounded-2xl rounded-tl-sm border border-red-500/15 bg-red-500/10 px-4 py-3">
                    <p className="text-sm text-slate-300">Paguei R$ 320 no cartao para marketing da empresa, recebi R$ 1.500 por Pix e preciso lembrar do aluguel no dia 5.</p>
                  </div>
                </div>
                <div className="flex flex-row-reverse gap-3">
                  ...
                  <div className="rounded-2xl rounded-tr-sm border border-slate-700/30 bg-slate-900/50 px-4 py-3">
                    <p className="mb-3 text-sm text-white">Entendi. Ja organizei tudo para voce:</p>
          ...
          <Card className="border-slate-700/50 bg-slate-800/30 p-12 text-center">
            <div className="space-y-4">
              ...
              <p className="mx-auto max-w-2xl text-slate-400">
                Essa funcionalidade ajuda voce a gerenciar {productTabs[activeTab].toLowerCase()} com contexto financeiro, organizacao e menos trabalho manual.
              </p>
            </div>
          </Card>
        )}
