      ...
      <div className="relative z-10 mx-auto max-w-6xl text-center">
        ...
        <div className="mb-8 flex items-center justify-center gap-4">
          ...
          <div className="text-left">
            <p className="text-xs uppercase tracking-[0.42em] text-red-300/70">
              Nano IA
            </p>
        ...
        <Badge
          variant="outline"
          className="border-red-500/20 bg-red-500/10 px-4 py-2 text-sm text-red-300 backdrop-blur-sm hover:bg-red-500/20"
        >
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <Button
            ...
            className="rounded-full px-8 py-6 text-lg font-semibold text-white transition-all hover:bg-white/10"
          >
            {hero.ctaSecondary}
          </Button>
        </div>
                ...
                <div className="space-y-3">
                  <div className="rounded-lg border border-red-500/20 bg-gradient-to-br from-red-500/15 to-red-950/10 p-5">
                    ...
                    <div className="mt-5 grid gap-3 md:grid-cols-3">
                      {[
                        ...
                        ["Cartão empresa", "R$ 3.280"],
                        ["Contas à vencer", "4 alertas"],
                      ].map(([label, value]) => (
                        <div
                          key={label}
                          className="rounded-xl border border-slate-700/50 bg-slate-950/40 p-3 text-left"
                        >
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      <div
                        key={label}
                        className="rounded-lg border border-slate-700/50 bg-slate-800/50 p-3 text-left"
                      >
